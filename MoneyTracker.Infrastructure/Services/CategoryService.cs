...
namespace MoneyTracker.Infrastructure.Services
{
    public class CategoryService : ICategoryService
    {
        ...
        public async Task<CategoryDto?> GetCategory(int id)
        {
            ...
            List<Category> categories = await _repo.GetAll(includeProp: "ParentCategory,SubCategories,Transactions"); //Incomes,Expenses
            if (categories == null)
            {
                return null;
            }
            Category ? category = await _repo.Get(c=> c.Id == id, includeProp: "ParentCategory,SubCategories,Transactions"); //Incomes,Expenses
            if (category == null)
            {
                return null;
            }
